...
class PlumbingListPage extends StatefulWidget {
  @override
  _PlumbingListPageState createState() => _PlumbingListPageState();
}

class _PlumbingListPageState extends State<PlumbingListPage> {
  ...
  final CollectionReference complaintStatusCollection =
      FirebaseFirestore.instance.collection('plumbing_status');
