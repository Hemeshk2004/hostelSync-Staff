...
class CarpentryListPage extends StatefulWidget {
  @override
  _CarpentryListPageState createState() => _CarpentryListPageState();
}

class _CarpentryListPageState extends State<CarpentryListPage> {
  ...
  final CollectionReference complaintStatusCollection =
      FirebaseFirestore.instance.collection('carpentry_status');
